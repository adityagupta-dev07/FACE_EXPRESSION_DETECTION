...
- 🧠 Pre-trained deep learning emotion recognition model  
...
│
├── detector.py
│ └── Face detection and emotion classification logic
│
├── ml_emotion.py
│ └── Loads trained emotion detection model
│
├── meme_loader.py
│ └── Maps detected emotions to visuals or responses
│
├── emotion_model.h5
│ └── Trained deep learning emotion model
│
...
│
├── test_ml.py
│ └── Tests emotion prediction logic
│
├── test_json.py
